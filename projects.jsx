    ...
    const projects = [
        {
            ...
            fullDescription: `
                        A 2D action platformer built from scratch with C++ and SFML. Features directional combat,
                        enemy AI with chase/attack behavior, sprite animation systems, and collision detection.
                         Demonstrates core game development concepts including state machines and health management.
                    `,
            images: [
                "assets/game1.png",
                "assets/game2.png"
        ...
        },
        {
            ...
            fullDescription: `
                        A responsive photography portfolio built with vanilla HTML, CSS, and JavaScript. Features a masonry-style CSS Grid gallery, custom lightbox modal, and category filtering. 
